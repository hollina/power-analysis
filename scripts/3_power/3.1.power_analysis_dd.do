...
capture program drop power_analysis_dd

// *----------
program define power_analysis_dd
syntax, ///
	end_value(real) ///
	step_size(real) ///
...
*----------
	quietly {
		...
		*/
		...
		local file_name_suffix dd_`prefix'_`death_type'_`dem_type'_cluster_`cluster_var'_weight_`weight_var'_controls_`list_of_controls'_preperiod_`first_year'_`last_year'
